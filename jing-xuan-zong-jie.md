...
{% hint style="info" %}
本文会保持长期顶置且随时更改，新增内容可能不会影响已精选文章但会影响正在申精的文章，此总结仅适用于黑洞区作品，实验区申请精选作品不遵循此条例，目前实验区精选请遵循管理条例原文。

【】为新规定添加日期，无【】则从管理条例中修改本文，本总结优先更新，《管理条例》最后更新

**每次阅读前或者和别人使用本文截图对线前刷新浏览器缓存/物理实验室内刷新实验内容。最近一次更新日期2023.6.3**
...
洗稿（发现后警告），缝合文章，未被科学证实内容（允许学说，此类字数需不少于1500字【2022.7.16】），纯介绍星球（仅可知识库），营销号，过分凑字数，二战及其全部相关内容（仅可知识库）【2022.3.25】，若文章需要角标，则必须使用size标签或者使用角标符号【2022.4.24】
...
若小说组织存在，则加知识库必须至少有一位小说组织的成员去点评作品，否则不允许加知识库【2022.12.12】

小说成员在"不允许"精选上的票数x2【2022.12.12】

小说组织审核中的成员不算入以上要求的点评，只有获得称号的小说组织成员才拥有以上权利【2022.12.12】
...
实验区一周两次申精【2022.8.2改】，黑洞区一周只能有一次申精，申精标签用完后就无法再有申精标签

被移动后两个分区的申精标签也都会被冷却（实验区剩余次数无效）
