...
**每次阅读前或者和别人使用本文截图对线前刷新浏览器缓存。最近一次更新日期2022.4.24**

<mark style="color:red;">码字请使用WPS/Office/笔记/便签，更推荐使用支持云同步的软件。</mark>

<mark style="color:red;">**新版本物理实验室码字会闪退且无法恢复未保存的实验介绍里的内容。**</mark>
{% endhint %}

## 文章要求

根据管理条例的意思：**知识库**的差距仅为复制率不满足精选要求或文章获得的支持数不够

黑洞区精选是收录在实验内无相关实验，实验介绍为一篇文章或教程，即纯介绍文章。

实验内摆字的文章应移动到黑洞区内

精选的复制部分不多于30%，知识库不多于50%

精选正文字数不少于750字，写系列需要每部作品至少1000字，历史学科不少于1500字【2022.3.1】（以物理实验室内文字统计为准，算复制率相同）
...
洗稿（仅可知识库），缝合文章，未被科学证实内容【2022.3.25】，纯介绍星球（仅可知识库），营销号，过分凑字数，二战及其全部相关内容（仅可知识库）【2022.3.25】，若文章需要角标，则必须使用size标签或者使用角标【2022.4.24】
...
若在重复率低于30%的文章的重复部分指向的网页与本文文章结构相同，也不能上精选
...
小号支持不记录统计，乱支持可能会遭受封禁处罚

编辑有权利向作者最多提出本文的三个问题，若不能全部正确回答则不能上精选
