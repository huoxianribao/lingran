...
**每次阅读前或者和别人使用本文截图对线前刷新浏览器缓存/物理实验室内刷新实验内容。最近一次更新日期2022.12.4**
...
字数统计均统计正文字数，后文所指的字数均为正文字数，跑题不允许精选

物理实验室内文字统计仅用于“申请精选”标签的初步过滤，具体字数统计以正常办公软件内的统计字符数为准
...
（计算重复占比和文章正文字数以word的字符数为准，与主题无关内容不记入总字数统计。重复占比=重复的字符数/文章正文字符数总和）
