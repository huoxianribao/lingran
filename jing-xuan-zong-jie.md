...
{% hint style="info" %}
本文会保持长期顶置且随时更改，新增内容可能不会影响已精选文章但会影响正在申精的文章，此总结仅适用于黑洞区作品，实验区作品不遵循此条例，目前实验区请遵循管理条例原文。

【】为新规定添加日期，无【】则从管理条例中修改本文，本总结优先更新，《管理条例》最后更新

**每次阅读前或者和别人使用本文截图对线前刷新浏览器缓存/物理实验室内刷新实验内容。最近一次更新日期2022.8.27**
...
物理实验室内文字统计仅用于“申请精选”标签的初步过滤，具体字数要求限制以office软件内的统计字符数为准
...
洗稿（发现后警告），缝合文章，未被科学证实内容【2022.3.25】，纯介绍星球（仅可知识库），营销号，过分凑字数，二战及其全部相关内容（仅可知识库）【2022.3.25】，若文章需要角标，则必须使用size标签或者使用角标符号【2022.4.24】
